...
def main():
    df = pd.read_csv("D:\\Internship\\biome-internship-projects\\Task4\\data\\diabetic_data.csv")
    ...
    preproc.convert_dtype_category(["admission_type_id", "discharge_disposition_id","admission_source_id"])
